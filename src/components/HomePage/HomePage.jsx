      ...
      <Grid container spacing={3} xs={12}>
        ...
        <Grid container item xs={7} className="scrollableDiv">
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 0 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 0 })
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 2 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 2 })
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 3 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 3 })
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 4 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 4 })
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 5 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 5 })
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 6 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 6 })
          ...
          <Grid
            ...
            onClick={() => {
              user.role === "customer"
                ? dispatch({ type: "SET_NEXT_BUTTON", payload: 7 })
                : {};
            }}
            onDoubleClick={() =>
              dispatch({ type: "SET_NEXT_BUTTON", payload: 7 })
