// Most important section of the manifesto
// It changes the font size according to the characters and fits them
// to a set length
// Any minor changes here can make the elements look stretched
...
function ManifestoSvgElement({ manifestoText }) {
  ...
  let variableFontSize =
    manifestoText.length < 4
      ? 50
      : 300 / (1.4 * (manifestoText.length + extra));

  return (
    <div className="smallColumnElement">
      <svg
        width="190"
        height={variableFontSize}
