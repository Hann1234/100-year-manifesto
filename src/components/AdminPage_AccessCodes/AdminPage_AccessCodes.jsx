...
function AdminPage_AccessCodes() {
  ...
  const convertSqlTimestampToJs = (timestampIn) => {
    ...
    const d = new Date(
      Date.UTC(t[0] * 1, t[1] * 1 - 1, t[2] * 1, t[3] * 1, t[4] * 1, t[5] * 1)
    );
                  ...
                  return (
                    <ListItem key={index}>
                      ...
                      <ListItemText
                        ...
                        secondary={
                          "Expires: " +
                          convertSqlTimestampToJs(element.expiration_date)
                        }
                      />
                        ...
                        <IconButton edge="end" aria-label="delete">
                          {deleteIndex === index ? (
                            <>
                              ...
                              />
                              <CheckIcon
                                onClick={() => deleteAccessCode(element.id)}
                              />
                            </>
                          ) : (
