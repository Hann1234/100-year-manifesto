...
function AdminEdits( {page_id, html_id, html_type = 'text', default_value}) {
    return (
        <>{
            html_type === 'text' ?
            ...
            html_type === 'array' ?
                <AdminEdits_Array page_names={page_names} page_id={page_id} html_id={html_id} default_value={default_value}/> :
            <></>
        }</>
    );
}
