        ...
        <>
          ...
          {showAccessCodes ? (
            <>
              <h2>
                Manage Access Codes{" "}
                <ExpandLessIcon onClick={() => setShowAccessCodes(false)} />
              </h2>
            ...
            <>
              <h2>
                Manage Access Codes{" "}
                <ExpandMoreIcon onClick={() => setShowAccessCodes(true)} />
              </h2>
            </>
          )}
          {showManageUsers ? (
            <>
              <h2>
                Manage Users{" "}
                <ExpandLessIcon onClick={() => setShowManageUsers(false)} />
              </h2>
            ...
            <>
              <h2>
                Manage Users{" "}
                <ExpandMoreIcon onClick={() => setShowManageUsers(true)} />
              </h2>
            </>
          )}
        </>
